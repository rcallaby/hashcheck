...
HashDetector::HashDetector() {
    ...
    hashTypes = {
        ...
        {"Argon2", 96, std::regex("^\\$argon2(id|i|d)?\\$[A-Za-z0-9$=,]+$"), "$argon2", 13300},
        {"BLAKE2b-512", 128, std::regex("^[0-9a-fA-F]{128}$"), "", 600},
        {"BLAKE2s-256", 64, std::regex("^[0-9a-fA-F]{64}$"), "", 600},
        {"bcrypt", 60, std::regex("^\\$2[aby]\\$[0-9]{2}\\$[./A-Za-z0-9]{53}$"), "$2", 3200},
        {"CHAP", 32, std::regex("^[0-9a-fA-F]{32}$"), "", 5003},
        ...
        {"HAVAL-128", 32, std::regex("^[0-9a-fA-F]{32}$"), "", 8800},
        {"HAVAL-160", 40, std::regex("^[0-9a-fA-F]{40}$"), "", 8800},
        {"HAVAL-192", 48, std::regex("^[0-9a-fA-F]{48}$"), "", 8800},
        {"HAVAL-224", 56, std::regex("^[0-9a-fA-F]{56}$"), "", 8800},
        {"HAVAL-256", 64, std::regex("^[0-9a-fA-F]{64}$"), "", 8800},
        {"Kerberos 5 etype 23", 32, std::regex("^[0-9A-Fa-f]{32}$"), "", 7500},
        {"Kerberos 5 etype 18 (AES256-CTS-HMAC-SHA1-96)", 64, std::regex("^[0-9A-Fa-f]{64}$"), "", 19900},
        ...
        {"RIPEMD-128", 32, std::regex("^[0-9A-Fa-f]{32}$"), "", 6000},
        ...
        {"Snefru-128", 32, std::regex("^[0-9a-fA-F]{32}$"), "", 13000},
        {"Snefru-256", 64, std::regex("^[0-9a-fA-F]{64}$"), "", 13000},
        {"Tiger-128", 32, std::regex("^[0-9a-fA-F]{32}$"), "", 10000},
        {"Tiger-160", 40, std::regex("^[0-9a-fA-F]{40}$"), "", 10000},
        {"Tiger-192", 48, std::regex("^[0-9a-fA-F]{48}$"), "", 10000},
